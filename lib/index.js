...
var QRScaner = (function (_super) {
    ...
    QRScaner.prototype.render = function () {
        var _a = this.props, _b = _a.videoAttr, videoAttr = _b === void 0 ? {} : _b, style = _a.style, className = _a.className;
        return React.createElement("video", __assign({ className: className, style: style }, videoAttr, { ref: this.previewer }));
    };
    return QRScaner;
}(React.Component));
